...
(** 興味深いケース([Star]に対応するものです)において、普通に証明を進められます。帰納法の仮説[IH2]が追加された前提[Star re'' = Start re']を意図したものであることに気をつけてください。その前提は、[remember]によって生成された等式に起因します。*)
...
(** Let's prove that our definition of [filter] from the [Poly]
    ...
    not a [Fixpoint].)  *)
(** [Poly]の章から我々の[filter]の定義が理論上の仕様を満たしていることを証明しましょう。ここで言う仕様とは日本語で非形式的に書くと以下のものになります。
